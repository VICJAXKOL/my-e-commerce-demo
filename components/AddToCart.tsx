    ...
    <div className="space-y-3">
      <div className="flex items-center gap-3">
        ...
        <button
          ...
          className={`btn-outline px-3 py-2 text-sm ${liked ? "text-pink-500" : "text-zinc-700"}`}
        >
      ...
      <button
        ...
        className={`w-full rounded px-4 py-2 text-white transition ${
          justAdded ? "bg-green-500 ring-2 ring-green-300 scale-105" : "btn-primary disabled:opacity-50"
        }`}
      >
